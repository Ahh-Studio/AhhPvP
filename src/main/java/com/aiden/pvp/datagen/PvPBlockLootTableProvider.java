...
public class PvPBlockLootTableProvider extends SimpleFabricLootTableProvider {
        public PvPBlockLootTableProvider(FabricDataOutput output,
                        CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
                super(output, registryLookup, LootContextTypes.BLOCK);
        }

        public static final RegistryKey<LootTable> SPAWNER_BLOCK = RegistryKey.of(RegistryKeys.LOOT_TABLE,
                        Identifier.ofVanilla("blocks/spawner"));
        public static final RegistryKey<LootTable> TRIAL_SPAWNER_BLOCK = RegistryKey.of(RegistryKeys.LOOT_TABLE,
                        Identifier.ofVanilla("blocks/trial_spawner"));
