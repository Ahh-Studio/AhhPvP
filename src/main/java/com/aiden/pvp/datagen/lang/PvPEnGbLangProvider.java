...
public class PvPEnGbLangProvider extends LanguageProvider {
    public PvPEnGbLangProvider(PackOutput output) {
        super(output, PvP.MOD_ID, "en_gb");
    }

    @Override
    protected void addTranslations() {
        this.add("block.pvp.boss_spawner", "Boss Murderer Spawner");
        ...
        this.add("item.pvp.boss_key", "Boss Murderer Key");
