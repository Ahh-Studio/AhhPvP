...
public class PvPEnGbLangProvider extends FabricLanguageProvider {
    public PvPEnGbLangProvider(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
        super(dataOutput, "en_gb", registryLookup);
    }

    @Override
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder builder) {
        builder.add("block.pvp.boss_spawner", "Boss Murderer Spawner");
        ...
        builder.add("item.pvp.boss_key", "Boss Murderer Key");
