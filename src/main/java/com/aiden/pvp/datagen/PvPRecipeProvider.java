...
public class PvPRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        shaped(RecipeCategory.MISC, Items.PLAYER_HEAD)
                ...
                .group("player_head")
                .save(this.output);
        offerBBUUpgradeRecipe(Items.WOODEN_SWORD, ModItems.WOODEN_SWORD.get());
        offerBBUUpgradeRecipe(Items.STONE_SWORD, ModItems.STONE_SWORD.get());
        offerBBUUpgradeRecipe(Items.IRON_SWORD, ModItems.IRON_SWORD.get());
        offerBBUUpgradeRecipe(Items.DIAMOND_SWORD, ModItems.DIAMOND_SWORD.get());
    }
