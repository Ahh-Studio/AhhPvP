...
public class ChickenDefenseEntity extends Animal {
    ...
    @Nullable
    public ChickenDefenseEntity getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        ChickenDefenseEntity chicken = ModEntityTypes.CHICKEN_DEFENSE.create(serverLevel, EntitySpawnReason.BREEDING);
        return chicken;
    }
