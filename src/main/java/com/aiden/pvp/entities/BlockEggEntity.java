...
public class BlockEggEntity extends ThrownItemEntity {
    private final Random random = new Random();
    public BlockEggEntity(EntityType<? extends BlockEggEntity> entityType, World world) {
        super(entityType, world);
        this.setGlowing(true);
    }

    public BlockEggEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.BLOCK_EGG, owner, world, stack);
    }

    public BlockEggEntity(World world, double x, double y, double z, ItemStack stack) {
        super(ModEntities.BLOCK_EGG, x, y, z, world, stack);
    }
    ...
    private void placeBlocks(int i, int j, int k) {
        getEntityWorld().setBlockState(
                this.blockPos(i, j, k),
                ModBlocks.BLOCK_EGG.getDefaultState(),
                6
        );
    }
