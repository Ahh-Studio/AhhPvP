...
public class PvPZhTwLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add("item.pvp.axe_of_murder", "謀殺之斧");
        ...
        this.add("item.pvp.chicken_defense", "小鷄炮臺");
        ...
        this.add("key.category.pvp.pvp", "PvP模組");
        this.add("key.pvp.open_settings", "打開設置");
        this.add("key.pvp.throw_tnt", "投擲TNT");
