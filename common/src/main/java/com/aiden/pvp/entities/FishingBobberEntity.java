...
public class FishingBobberEntity extends Projectile {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if (hitEntity instanceof LivingEntity livingEntity && this.level() instanceof ServerLevel serverWorld) {
            Entity owner = this.getOwner();
            if (owner != null) {
                livingEntity.hurtServer(serverWorld, owner.damageSources().thrown(this, owner), 1);
